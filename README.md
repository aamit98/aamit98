...
Backend - Spring Boot - Node.js - Express - REST APIs - JWT authentication - WebSockets

Data & Storage - PostgreSQL - SQLite - MongoDB - Schema design - Transactions - Data consistency

Infra / DevOps - Docker - Docker Compose - Linux - Git - Basic CI/CD

I care about readable code, clear ownership, and systems that behave the same in production as they do locally.
...
- Separation between control plane (API) and data plane (file transfer)
